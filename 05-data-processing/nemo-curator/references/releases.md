...
Version history for this repository (19 releases).

## v1.0.0: NVIDIA NeMo Curator 1.0.0
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v1.0.0)

---

## v0.9.0: NVIDIA NeMo Curator 0.9.0
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.9.0)

---

## v0.8.0: NVIDIA NeMo Curator 0.8.0
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.8.0)

---

## v0.8.0rc3.dev0: NVIDIA NeMo Curator 0.8.0rc3.dev0
**Published:** 2025-04-15
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.8.0rc3.dev0 (2025-04-15)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.8.0rc3.dev0)

---

## v0.8.0rc2.dev0: NVIDIA NeMo Curator 0.8.0rc2.dev0
**Published:** 2025-04-07
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.8.0rc2.dev0 (2025-04-07)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.8.0rc2.dev0)

---

## v0.7.1: NVIDIA NeMo Curator 0.7.1
**Published:** 2025-03-31

- Fix Transformers + Cuda Context bug
- Fix rate limit in SDG Retriever Eval Tutorial

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.7.1)

---

## v0.7.0: NVIDIA NeMo Curator 0.7.0
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.7.0)

---

## v0.7.0rc2.dev0: NVIDIA NeMo Curator 0.7.0rc2.dev0
**Published:** 2025-02-25
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.7.0rc2.dev0 (2025-02-25)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.7.0rc2.dev0)

---

## v0.7.0rc1.dev1: NVIDIA NeMo Curator 0.7.0rc1.dev1
**Published:** 2025-02-19
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.7.0rc1.dev1 (2025-02-19)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.7.0rc1.dev1)

---

## v0.7.0rc0.dev1: NVIDIA NeMo Curator 0.7.0rc0.dev1
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.7.0rc0.dev1)

---

## v0.6.0: NVIDIA NeMo Curator 0.6.0
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.6.0)

---

## v0.6.0rc2.dev1: NVIDIA NeMo Curator 0.6.0rc2.dev1
**Published:** 2025-01-03
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.6.0rc2.dev1 (2025-01-03)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.6.0rc2.dev1)

---

## 0.6.0rc1.dev1: NVIDIA NeMo Curator 0.6.0rc1.dev1
**Published:** 2024-12-20
**Pre-release**

Prerelease: NVIDIA NeMo Curator 0.6.0rc1.dev1 (2024-12-20)

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/0.6.0rc1.dev1)
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.6.0rc0)
...
**Full Changelog**: https://github.com/NVIDIA/NeMo-Curator/compare/v0.5.0...v0.5.1

[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.5.1)
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.5.0)
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.4.1)
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.4.0)
...
[View on GitHub](https://github.com/NVIDIA-NeMo/Curator/releases/tag/v0.3.0)
